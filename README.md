#Eatzilla
# Eatzilla - Food Delivery Platform
...
- **Material UI**: UI components library for building modern, responsive interfaces.
- **Formik**: Form management library for handling form state and validation.
